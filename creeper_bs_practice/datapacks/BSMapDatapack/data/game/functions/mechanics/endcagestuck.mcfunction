...
execute if score dummy ecgInPrac matches 1 run execute as @a at @s run execute if entity @s[x=28,y=97,z=-27,dx=0.3,dz=0.3,dy=1] run execute if score dummy ecgTimeSec < dummy ecgPBTimeSec run tellraw @a {"text":"(New PB!)","color":"gold"}
execute if score dummy ecgInPrac matches 1 run execute as @a at @s run execute if entity @s[x=28,y=97,z=-27,dx=0.3,dz=0.3,dy=1] run execute if score dummy ecgTimeSec < dummy ecgPBTimeSec run scoreboard players operation dummy ecgPBTimeMs = dummy ecgTimeMs
execute if score dummy ecgInPrac matches 1 run execute as @a at @s run execute if entity @s[x=28,y=97,z=-27,dx=0.3,dz=0.3,dy=1] run execute if score dummy ecgTimeSec < dummy ecgPBTimeSec run scoreboard players operation dummy ecgPBTimeSec = dummy ecgTimeSec
execute if score dummy ecgInPrac matches 1 run execute as @a at @s run execute if entity @s[x=28,y=97,z=-27,dx=0.3,dz=0.3,dy=1] run execute if score dummy ecgTimeSec = dummy ecgPBTimeSec run execute if score dummy ecgTimeMs < dummy ecgPBTimeMs run tellraw @a {"text":"(New PB!)","color":"gold"}
...
execute if score dummy ecgInPrac matches 1 run execute as @a at @s run execute if entity @s[x=28,y=97,z=-27,dx=0.3,dz=0.3,dy=1] run function game:mechanics/ecgreset
